...
public class ZhongKeBase {

    private String TAG = "ZhongKeBase" ;
    ...
    private static class SingletonHolder {
        private static final ZhongKeBase INSTANCE = new ZhongKeBase();
    }
    public static ZhongKeBase getInstance() {
    ...
    protected void readTts(String str) {
        try {
            ...
            if (FunctionConstants.STORY_CODE == code) {
                return;
            }
            if (FunctionConstants.SONG_CODE == code){
                return;
            }
