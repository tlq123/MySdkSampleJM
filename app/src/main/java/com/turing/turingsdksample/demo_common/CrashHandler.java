...
//        autoClear(5);
    ...
    private String writeFile(String sb) throws Exception {
        ...
        boolean flag = ExistSDCard() ;
        Log.e(TAG,"flag=="+flag +"   fileName:"+fileName);
        if (flag) {
    ...
    public static String getGlobalpath() {
        String path = Environment.getExternalStorageDirectory().getAbsolutePath()
                + File.separator +"logFile"+ File.separator;
        Log.e(TAG,"path=="+path +"   getExternalStorageState:"+Environment.getExternalStorageState());
        return path;
    }
    ...
    public  String writeFilePhone(String sb) throws Exception {
        String fileName = "phoneNum-" + formatter.format(new Date()) + ".txt";
        fileName = fileName.replaceAll(" ","_");
        boolean flag = ExistSDCard() ;
        Log.e(TAG,"flag=="+flag +"   fileName:"+fileName);
        if (flag) {
